...
//                 onPressed: () {
//                   customersRM.remove(customerID);
//                 },
//               ).pad(),
//               IconButton.filled(
//                 icon: customer.name.toUpperCase().text(),
//                 onPressed: () => RM.navigate.to(CustomerPage(customerID: customerID)),
//               ).pad(),
//               IconButton.filled(
...
//                             customersRM(
//                               customer.copyWith(
//                                 products: List.of(customer.products)..remove(eachProduct.id),
//                               ),
//                             );
//                           },
